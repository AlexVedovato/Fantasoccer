...
<?php
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <?php 
                  if ($_GET['error']==1){
                    echo 'Mancano i dati necessari per inserire il pagellista.';
                  } else if($_GET['error']==2){
                    echo 'Manca l\' username per inserire il pagellista.';
                  } else if($_GET['error']==3){
                    echo 'Manca la password per inserire il pagellista.';
    ...
    <div class="container">
        ...
        <div style="margin-top:100px">
            ...
            <form method="POST" action="./insertPagellista.php">
                <div class="form-group">
                    <label for="inputDataOra">Username</label>
                    <input type="text" class="form-control" id="username" name="username">
                </div>

                <div class="form-group">
                    <label for="inputDataOra">Password</label>
