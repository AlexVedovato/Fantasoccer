...
if(isset($_GET["id_modulo"]) && !empty($_GET["id_modulo"])){
    ...
    <div class="container">
        <div class="fixed-top">
            <nav class="navbar navbar-light bg-info">
                <a class="navbar-brand" href="#">GESTIONE MODULO</a>
            </nav>
        </div>
        <div style="margin-top:100px">

        <form method="POST" action="./updateModulo.php">
        <input type="number" name="id_modulo" <?php echo('value='.$_GET["id_modulo"]) ?> hidden>
            <div class="form-group">
                <label for="inputNumDifensori">Numero Difensori</label>
                <input type="number" min="1" class="form-control" id="inputNumDifensori" name="numeroDifensori" <?php echo('value='.$modulo["numero_difensori"])?>>
            </div>
            <div class="form-group">
                <label for="inputNumCentrocampisti">Numero Centrocampisti</label>
                <input type="number" min="1" class="form-control" id="inputLastName" name="numeroCentrocampisti" <?php echo('value='.$modulo["numero_centrocampisti"])?>>
            </div>

            <div class="form-group">
                <label for="inputNumAttaccanti">Numero Attaccanti</label>
                <input type="number" min="1" class="form-control" id="inputNumAttaccanti" name="numeroAttaccanti"<?php echo('value='.$modulo["numero_attaccanti"])?>>
            </div>
